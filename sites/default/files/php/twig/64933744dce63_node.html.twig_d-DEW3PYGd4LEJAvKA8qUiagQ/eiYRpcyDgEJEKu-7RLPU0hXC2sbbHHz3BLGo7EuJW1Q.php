...
/* themes/mike_tarica_site/templates/content/node.html.twig */
class __TwigTemplate_1424a84410e33bf7d6403d0ef622f1a0 extends Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 77, $this->source)))) : (""))];
        // line 80
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->attachLibrary("mike_tarica_site/node"), "html", null, true);
        echo "
<article";
        // line 81
...
";
    ...
    {
        return "themes/mike_tarica_site/templates/content/node.html.twig";
    }
    ...
    {
        return new Source("", "themes/mike_tarica_site/templates/content/node.html.twig", "/var/www/html/themes/mike_tarica_site/templates/content/node.html.twig");
    }
